...
export const WHEEL_GAMES: WheelGame[] = [
  ...
  { id: 'crystalrobot', name: 'Crystal Robot', provider: 'Hacksaw Gaming', image: '/wheel/crystalrobot.jpg' },
  ...
  { id: 'piratebonanza2', name: 'Pirate Bonanza 2', provider: 'Hacksaw Gaming', image: '/wheel/piratebonanza2.jpg' },
