...
const SOCIALS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
        <path d="M11.282 0H6.812L0 6.81v10.38L6.813 24h4.47l3.234-3.234V17.28l-4.03 4.03H7.56L1.688 15.44V8.561L7.559 2.69h2.928l4.03 4.03V3.234zm1.436 10.688-1.594 1.596 1.594 1.594h3.563l3.234-3.235V3.234L16.282 0h-4.469L8.578 3.234v3.485l4.03-4.03h2.928l5.874 5.873v6.876l-5.875 5.872H12.61l-4.032-4.03v3.485L11.813 24h4.469L23.094 17.19V6.81L16.282 0H11.81z"/>
      </svg>
    ),
  },
  {
